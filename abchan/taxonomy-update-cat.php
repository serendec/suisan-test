	...
	<div class="container">
		...
		<div class="l-inner">
			...
			<ul class="p-category-link mb-5">
				<li class=""><a href="<?php echo esc_url( home_url( '/' ) ); ?>update/">すべて</a></li>
			<?php
			$taxonomy = 'update-cat';
			$args = array(
				'hide_empty' => false,
			...
			foreach ( $terms as $term ):
				...
				<li class="<?php if( $term->name === '漁海況予報'){ echo ' is-cat2';} elseif($term->name === '水産資源評価結果') { echo ' is-cat1';} ?><?php if($c_term === $term->slug){ echo ' is-active';} ?>">
